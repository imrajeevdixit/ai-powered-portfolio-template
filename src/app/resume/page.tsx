        ...
        <div id="resume-content" className={`${isDark ? 'bg-slate-900' : 'bg-white'} shadow-2xl rounded-lg overflow-hidden print:shadow-none print:rounded-none`}>
          <div className={`${isDark ? 'bg-gradient-to-r from-indigo-900/20 to-purple-900/20' : 'bg-gradient-to-r from-indigo-50 to-purple-50'} p-12 print-header`}>
            ...
            <p className={`text-xl ${isDark ? 'text-indigo-400' : 'text-indigo-600'} mb-6 font-medium subtitle`}>
              Software Engineer | Technical Lead | Your Specialty
            </p>
            ...
            >
              ...
              <a
                href="https://your-newsletter.beehiiv.com/"
                target="_blank"
                rel="noreferrer"
                className={`
                  flex items-center gap-2 rounded-full px-3 py-1 transition-colors border
          ...
          <div className="p-12 print-compact space-y-10 print-spacing">
            <section className="print-section-spacing">
              ...
              <p className={`${isDark ? 'text-slate-300' : 'text-slate-700'} leading-relaxed`}>
                Accomplished Software Engineer with over [X] years of experience building scalable web applications and distributed systems. Proven track record of leading technical initiatives and mentoring teams. Expert in cloud architecture, modern JavaScript frameworks, and DevOps practices.
              </p>
            </section>
            ...
            <section className="print-section-spacing">
              ...
              <ul className={`list-disc list-inside space-y-2 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
                <li>Led engineering teams to deliver projects on time and under budget</li>
                <li>Architected systems serving millions of users with 99.9% uptime</li>
                ...
                <li>Drove cost optimization initiatives while maintaining system reliability</li>
              </ul>
            </section>
          </div>
        </div>
