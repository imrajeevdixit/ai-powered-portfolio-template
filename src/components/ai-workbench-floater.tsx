...
const SUGGESTED_QUESTIONS = [
  "What's your experience with AI and GenAI?",
  "Tell me about your leadership philosophy",
  "What major companies have you worked for?",
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      ...
      setTimeout(() => {
        setMessages([{
          role: 'assistant',
          content: "Hello! I'm an AI assistant. Ask me anything about the portfolio owner!",
          timestamp: new Date()
        }])
