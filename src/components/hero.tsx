...
export default function Hero() {
  ...
  const fullText = "Your Tagline Here.";
      ...
      <div className="flex flex-col items-start justify-center relative">
        ...
        <FadeInSection delay={200}>
          <p className={`text-lg md:text-xl ${isDark ? 'text-slate-400' : 'text-slate-500'} max-w-2xl mb-10 leading-relaxed hover:text-slate-300 transition-colors duration-300`}>
            [X] years of experience building scalable applications and leading engineering teams. Passionate about creating impactful solutions that solve real-world problems. Let&apos;s build something amazing together.
          </p>
        </FadeInSection>
